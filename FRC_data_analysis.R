...
# the matrix used to store needed informations: division, the number of clusters, 1-MSPE_D, MSPE_P, MSPE_Y, the numbers of correct predictions of semifinals, finals, and champion
...
d = 2 # the threshold value for reestimate robots strengths 
#set d equal to the number of robots for LCT method
...
for(div in 1:12){ # div in 1:12 represent "Carver", "Galileo", "Hopper", "Newton", "Roebling", "Turing", "Archimedes", "Carson", "Curie", "Daly", "Darwin", "Tesla" division 
  ...
  beta_Est = Classification.fn(x0,y0,d) # perform the TCL or LCT method
