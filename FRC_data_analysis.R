...
# the matrix used to store needed informations: division, the number of clusters, 1-MSPE_D, MSPE_P, MSPE_Y, the numbers of correct predictions of semifinals, finals, and champio
